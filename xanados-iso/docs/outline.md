# XanadOS – High-Level Master Overview

🔹 Purpose, Focus & Vision
XanadOS is an Arch-based Linux distribution focused on:

🎮 High-performance gaming

🔐 Security and privacy-first architecture

🧠 User control via modular onboarding

💻 Aesthetic coherence across boot, login, and desktop

Core Goals:

Serve as a daily driver and elite gaming environment

Be fully customizable at install or first login

Ensure zero bloat, only what the user chooses

Maintain modular logic, so nothing is forced
...
Theming Configurable with optional dark mode
Terminal Alacritty (default)
System Monitors btop, Conky
Bootloader Configurable GRUB theme
Boot Splash Plymouth animation (ASCII style)
Login Screen SDDM with optional theming
...
🧠 What This ISO Does
Boots into a KDE Plasma Live Environment with default settings

Runs a pre-configured Welcome App for optional setup

Allows secure or standard install with custom feature selection

Can be installed to internal SSD/NVMe with persistent configuration

Leaves the user in full control, no forced bloat or apps
